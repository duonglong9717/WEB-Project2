			...
			<div class="flip-card">
				<div class="flip-card-inner">
					<div class="flip-card-front">
						...
						<img src="https://marvelvietnam.com/wp-content/uploads/2021/03/top-10-sieu-anh-hung-manh-nhat.jpg" alt="Avatar" style=" border-radius: 50%; width: 80%; height: 80%; object-fit: cover;
			...
			<div class="flip-card">
				<div class="flip-card-inner">
					<div class="flip-card-front">
						...
						<img class='text-center' src="https://znews-photo.zadn.vn/w660/Uploaded/ngogtn/2020_04_21/avengers_endgame.jpg" alt="Avatar" style="border-radius: 50%; width: 80%; height: 80%; object-fit: cover;
						display: block; margin-left: auto; margin-right: auto;">
					</div>
					<div class="flip-card-back">
						<h3>Login</h3>
